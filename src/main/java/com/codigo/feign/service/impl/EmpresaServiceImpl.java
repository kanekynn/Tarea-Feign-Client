...
public class EmpresaServiceImpl implements EmpresaService {
    ...
    @Override
    public BaseResponse crearEmpresa(EmpresaResquest empresaResquest) {
        return null;
    }
    ...
    public BaseResponse getInfoSunat(String numero) {
        ...
        if (response != null)
        {
            return new BaseResponse(Constants.CODE_SUCCESS, Constants.MESS_SUCCESS,
                    Optional.of(response));
        }else
        {
            return new BaseResponse(Constants.CODE_ERROR, Constants.MESS_ERROR,
                    Optional.empty());
        }
